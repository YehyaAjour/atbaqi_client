  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        Expanded(
          child: Column(
            children: [
              ...
              Obx(() {
                return cartController.getCartListData.value.status == null
                    ? SizedBox()
              ...
              Obx(() {
                return cartController.getCartListData.value.msg == null
                    ? Helper.loading()
                    : cartController.getCartListData.value.cartItems.length == 0
                        ? CustomText(
        ...
        Obx(() => cartController.getCartListData.value.cartItems == null
            ? SizedBox()
            : cartController.getCartListData.value.cartItems.length == 0
                ? SizedBox()
                : Column(
